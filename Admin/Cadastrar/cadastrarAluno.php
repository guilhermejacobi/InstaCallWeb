<html>
    <head>
        ...
        <title>Matricular Aluno- InstaCall</title>
    </head>
    <header>
            ...
            <div>
                <table class="tabelaPrincipal">
                    <tr>
                        ...
                        <td><input type="text" id="matricula" name="matricula" disabled></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="button" class="botao" onclick="buscaCep()" value="Buscar"></input></td>
                    </tr>
                    <tr>
                        <td id="direita">UF: </td>
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="button" onclick="buscarIdTurma2()" class="botao" value="Buscar"></td>
                    </tr>
                    <tr>
                        <td></td>
