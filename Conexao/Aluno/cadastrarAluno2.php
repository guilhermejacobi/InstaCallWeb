...
try{
  $sql= "INSERT INTO aluno (nomeAluno, cpfAluno, nascAluno, telAluno, cepAluno, ufAluno, cidadeAluno, bairroAluno, logradouroAluno, numAluno, idTurma, loginAluno, senhaAluno) VALUES (:nome, :cpf, :nasc, :tel, :cep, :uf, :cidade, :bairro, :logradouro, :num, :idTurma, :loginAluno, :senhaAluno)";
