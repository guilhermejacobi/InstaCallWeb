...
try{
  $sql= "INSERT INTO aluno (nomeAluno, cpfAluno, nascAluno, cepAluno, ufAluno, cidadeAluno, bairroAluno, logradouroAluno, numAluno, idTurma, loginAluno, senhaAluno) VALUES (:nome, :cpf, :nasc, :cep, :uf, :cidade, :bairro, :logradouro, :num, :idTurma, :loginAluno, :senhaAluno)";
