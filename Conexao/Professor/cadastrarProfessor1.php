...
try{
  $sql = ("INSERT INTO professor (nomeProf, cpfProf, nascProf, cepProf, ufProf, cidadeProf, bairroProf, logradouroProf, numProf, formacaoProf, nivelProf, instituicaoProf, idTurma, loginProf, senhaProf) VALUES (:nome, :cpf, :nasc,:cep, :uf, :cidade, :bairro, :logradouro, :num, :formacao, :nivel, :nomeInst, :idTurma, :loginProf, :senhaProf)");
