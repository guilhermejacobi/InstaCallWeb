<html>
    <link href="estudante.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Cookie&display=swap" rel="stylesheet">
    <head>
        <title>Notas-Estudante-UniSociesc</title>
    </head>
    <header>
    ...
    <body id="fundoCinza">
        ...
        <div class="tabela">
            <table>
                <tr>
                    <th class="table1"><img class="logoTabela" src="../Imagens/Logo.png" alt=""></th>
                    <th class="table2"><font class="fonteAtividade">Notas</font></th>
                </tr>
                <tr>
                    <th class="table3"></th>
                    <th class="table4"><table style="border: 1px solid black">
                        <tr>
